function createItemElement(item) {
    ...
    addButton.className = 'mt-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600';
    
    // Aggiungi l'evento di click per il pulsante "Aggiungi al carrello"
    addButton.addEventListener('click', function() {
      // Puoi aggiungere qui la logica per aggiungere l'elemento al carrello
      console.log('Articolo aggiunto al carrello:', item.name);
    });
